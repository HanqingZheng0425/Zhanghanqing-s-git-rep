...
speedy = 1
hp = 4
# The sequence generated by candy can generate candy continuously
for i in range(0, 4):
...
# Button and button click events
class Button(object):
    ...
    if hp > 0 and hp < 4 and score >= 0:
        ...
        for i in range(len(lx)):
            ...
            if ly[i] > 610 + 600:
                ...
                score -= 5
                text1 = font.render(str(score), True, (255, 255, 255))
            # The width of the main character is 62 and the height is 48
            # Spirit collision judgment
            if lx[i] + 24 > bx and \
                    lx[i] + 24 < bx + 62 and \
                    ly[i] >= 1120 and \
                    ly[i] <= 1140:
        ...
        # The protagonist follows the mouse
        ...
        if bx > 610 - 62:
            bx = 548
        # Control the protagonist through the keyboard
